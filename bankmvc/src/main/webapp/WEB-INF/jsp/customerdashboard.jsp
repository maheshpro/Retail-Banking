...
<body class="doodle">
	...
	<!--------------------- Navigation------------------>
		...
		<li><div class="navbar-brand">&nbsp;&nbsp;MRKG Bank</div></li>
		<li style="float:right"><a class="active"  href="/logout">Logout</a></li>
		</ul>

			<!--------------------- Details------------------>
		<center>
			<br><h1 style="font-weight: 400;">Welcome to MRKG Bank</h1>
		</center>
		
				
			<div style="margin: 9em 120em 14em 10em;">
...
<div class="col-xs-6 col-sm-3 col-md-3">
	<div style="margin: -44.5em 12em 5em 45em;">
					...
					<div class="card-body">
						...
						<form:select path="accountId" name="accountId">
							...
							<input type="number" name="targetAccount" minlength="8" placeholder="Enter the Target Account ID" required="required"/>
							<br> <br>
							<label for="amount">Enter Amount:</label><span class="required" style="color: red;"> *</span><br>
							...
							<br><br><h6>Minimum balance of 1000 Rs. should be maintained.</h6>
							<!-- <h7>If not, 10% will be deducted from your account!</h7> -->
							<br><br> <input type="submit" name="View" value="Transfer Amount" class="btn btn-success" /><br>
						</form:form>
						<br>
						<p style="font-family: Bradley Hand ITC; color: cornflowerblue;" id="message">${transfermsg}</p>
					</div>
				</div>
			</div>
		</div>
