...
<body >
	...
	<br>
		<h1 align="center">Welcome to MRKG Bank</h1>
  ...
  <div class="col-xs-12 col-sm-6 col-md-4">
			<div style="margin: 5em 10em 2em 3em;">
				<div class="card" style="width: 340px;height:250px; background: rgb(0, 0, 0); /* Fallback color */
  					background: rgba(0, 0, 0, 0.5); /* Black background with 0.5 opacity */
  					color: #f1f1f1;">
					<div class="card-body">
			...
			<div style="margin: 4em 10em 14em 3em;">
				<div class="card" style="width:340px;height:250px; background: rgb(0, 0, 0); /* Fallback color */
					...
					<div class="card-body">
                        ...
                        <p class="card-text">Charges will be deducted for not maintaining the minimum balance </p>
